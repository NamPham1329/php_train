...
{
    header('location: /php_train/login');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <form method="POST" action="/php_train/update-order">
        <div class="container padding-bottom-3x mb-1">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <form method="POST" action="/php_train/delete-all-order">
                                    <button class="btn btn-sm btn-outline-danger" style="display: none;" type="submit" name="deleteAll" value="<?php 
                                    if(!empty($data[0]['order_id'])){
                                        echo $data[0]['order_id']; 
                                    }
                                    ?>">Clear Cart</button>
                                </form>
                                <form method="POST" action="delete-all-order">
                                <button class="btn btn-sm btn-outline-danger" type="submit" name="deleteAll" value="<?php 
                                    if(!empty($data[0]['order_id'])){
                                        echo $data[0]['order_id']; 
                                    }
                                    ?>">Clear Cart</button>
            ...
            <div class="shopping-cart-footer">
                <div class="column"><a class="btn btn-outline-secondary" href="/php_train/home"><i class="icon-arrow-left"></i>&nbsp;Back to Shopping</a></div>
                <div class="column">
                    <button class="btn btn-primary" type="submit" name="update" value="<?php echo $item['order_id'] ?>">Update</button>
