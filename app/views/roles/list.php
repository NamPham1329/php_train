                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-right" style="position: absolute; right: 2%;">
                            <a href="/php_train/admin/them-chuc-nang">
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    <a href="/php_train/admin/update-role/id-<?php echo $values['id'];?>.html" style="margin-right: 5px;">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                    </a>
                                                    <form method="post" action="/php_train/admin/xoa-chuc-nang" style="margin-right: 5px;">
